...
func Peticion_solicitar_pedido(pedido *estructura.Pedido) estructura.JSONMessageGeneric{
	...
	var data = decodificador(resp.Body,&estructura.JSONMessageGeneric{"",0})
...
func Peticion_solicitar_estado_restaurante(jsonGeneric *estructura.JSONGenerico) estructura.JSONMessageGeneric{
...
func Peticion_estado_repartidor(jsonGeneric *estructura.JSONGenerico) estructura.JSONMessageGeneric{
...
func decodificador(body io.ReadCloser, data *estructura.JSONMessageGeneric) estructura.JSONMessageGeneric  {
